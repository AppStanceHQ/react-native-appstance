...
exports.default = exports.AppStanceWrapper = void 0;
var _reactNative = require("react-native");
const LINKING_ERROR = `The package 'react-native-appstance' doesn't seem to be linked. Make sure: \n\n` + _reactNative.Platform.select({
  ios: "- You have run 'pod install'\n",
  default: ''
}) + '- You rebuilt the app after installing the package\n' + '- You are not using Expo Go\n';
const AppstanceModule = _reactNative.NativeModules.Appstance ? _reactNative.NativeModules.Appstance : new Proxy({}, {
  get() {
 ...
 * const config = await AppStance.getRemoteConfig();
 */
exports.AppStanceWrapper = AppStanceWrapper;
const AppStance = new AppStanceWrapper();
var _default = exports.default = AppStance;
